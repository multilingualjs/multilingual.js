...
| `wrapWhitespace` | boolean | `true` | Absorb whitespace/punctuation into the surrounding span. Set `false` for tight spans (no background/border bleed across spaces). |
